# Generated by Powerlevel10k configuration wizard on 2022-10-27 at 00:08 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='󰽰' # ❯
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%2F' #'%76F'   # green foreground
      local   modified='%3F' #'%178F'  # yellow foreground
      local  untracked='%4F' #'%39F'   # blue foreground
      local conflicted='%1F' #'%196F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%f' #'%f'  # grey foreground
      local      clean='%2F' #'%f'  # grey foreground
      local   modified='%3F' #'%f'  # grey foreground
      local  untracked='%4F' #'%f'  # grey foreground
      local conflicted='%1F' #'%f'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=$blue #37
  ...
  typeset -g POWERLEVEL9K_BATTERY_LOW_THRESHOLD="blue" #20
  typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND="red" #160
  # Show battery in green when it's charging or fully charged.
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=$green #70
  # Show battery in yellow when it's discharging.
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND="yellow" #178
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$grey #66
