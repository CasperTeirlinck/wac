...
theme.titlebar_close_button_focus_hover         = assets_path .. "titlebar/close_normal_hover.svg"
...
-- theme.titlebar_bgimage                          = gears.surface.load_from_shape(300, 50, gears.shape.rounded_rect)

-- Define the icon theme for application icons. If not set then the icons
-- from /usr/share/icons and /usr/share/icons/hicolor will be used.
theme.icon_theme                                = "Papirus"

-- Bling utilities: mstab layout
theme.mstab_bar_padding                         = 0
theme.mstab_border_radius                       = 5
